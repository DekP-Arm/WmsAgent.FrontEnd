                ...
                <div className="hidden bg-cover lg:block lg:w-2/3" >
                    <div className="flex items-center h-full bg-gray-900 bg-opacity-40">
                        <div className="flex w-full h-full flex-col justify-center px-10 py-16 lg:px- z-10 bg-gradient-to-r
                            ...
                            to-purple-500
                            background-animate">
                            <h2 className="text-4xl font-bold lg:mt-60 lg:ml-10 text-white">WMS Lite</h2>
                    ...
                    <div className="flex-1">
                        <div className="text-center">
                            ...
                            <div className="">
                                ...
                                <div className="text-4xl font-bold text-center text-gray-700 dark:text-white">WMS Lite</div>
                            </div>
