...
export function Navbar() {
  ...
  return (
    <nav className={`${isDarkMode ? 'bg-zinc-800' : 'bg-gray-200'} p-2 flex sticky top-0 z-50 buttonClick duration-500 items-center justify-between`}>
      <div className='flex'>
